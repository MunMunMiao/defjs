---
title: POST JSON
description: 用 struct.json 发 JSON body，解码声明过的 201。
---

# POST JSON

Body 包进 `struct.json(...)`。逻辑字段名留在 TypeScript；线上别名写在 Struct 上。

细节见 [Commands](../core/commands.md) 和 [HTTP](../core/http.md)。
