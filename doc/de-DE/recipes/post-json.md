---
title: POST JSON
description: JSON-Body mit struct.json senden und deklariertes 201 dekodieren.
---

# POST JSON

Wickle den Body in `struct.json(...)`. Logische Feldnamen bleiben in TypeScript; Wire-Aliasse gehören auf den Struct.
