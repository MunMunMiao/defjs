...
Diese Seite bietet kopierfertige Beispiele für die häufigsten Anwendungsfälle.
...
## SSE-Echtzeitbenachrichtigungen
...
| Export                                                                                      | Typische Nutzung              |
| ------------------------------------------------------------------------------------------- | ----------------------------- |
| `createClient(...options)`                                                                  | Client-Instanz erstellen      |
| `withEndpoint(url)`                                                                         | Basis-URL setzen              |
| `withInterceptors(...interceptors)`                                                         | Interceptors registrieren     |
